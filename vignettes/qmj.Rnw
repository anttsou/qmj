...
<<>>=
safety <- market_data(companies,financials,prices)
...
\hypertarget{bibliography}{Asness, Clifford S., Andrea Frazzini, and Lasse H. Pedersen. ``Quality Minus Junk." AQR (2013)}
\end{document}