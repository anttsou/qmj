#' Creates a list of Company objects.
#'
#' Creates a list of Company objects, which allow for much greater analysis of
...
create_companies <- function(x, financials, prices){
  create_company <- function(ticker, profitability, pGPOA, pROE, pROA, pCFOA, pGMAR, pACC,
  ...
  mapply(create_company, x$ticker, data_profitability$profitability, data_profitability$GPOA, data_profitability$ROE,
