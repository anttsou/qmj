...
#   print(head(IVOL))
  ...
  TLTA <- (as.numeric(as.character(fstyear$TD)) - as.numeric(as.character(fstyear$MI)) - 
  ...
  INTWO <- as.numeric(as.character(fstyear$NI)) < 0 && as.numeric(as.character(sndyear$NI)) < 0
