...
tidy_incomestatements <- function(x) {
  ...
  colnames(incomestatements) <- c("name", "ticker", "year", "REV", "OREV", "TREV", "CREV", "GPROF", "SGAE", "RD", "DP", "NINT", "UI", "OOE", "TOE", "OI", "INT", "GSA", "OTH", "IBT", "IAT", "MI", "EIA", "NIBEI", "AC", "DO", "EI", "NI", "PD", "IACEEI", "IACIEI", "BWAS", "BEPSEEI", "BEPSIEI", "DILADJ", "DILWAS", "DILEPSEEI", "DILEPSIEI", "DIVC", "GDIV", "NIASBCE", "BEPSSBCE", "DEPSSBCE", "DPSUP", "TSI", "NIBT", "ESIIT", "ITISI", "NIAT", "NIAC", "BNEPS", "DNEPS")
